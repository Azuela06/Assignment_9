...
pdf.set_text_color(0,0,0)
pdf.set_font('Times', 'B', size=12)
pdf.cell(50,1, txt=mydata['Experience'][1]['work'], ln= 1, align= 'R')
pdf.set_font('Times', '', size=12)
pdf.set_text_color(0,0,0)
pdf.cell(30,9, txt=mydata['Experience'][1]['company2'], ln= 1, align= 'R')
pdf.cell(55,1, txt=mydata['Experience'][1]['address'], ln=1, align= 'R')
pdf.cell(38,9, txt=mydata['Experience'][1]['position'], ln= 1, align= 'R')

#--last part na hnggg---
pdf.set_text_color(0,0,0)
pdf.set_font('Times', 'B', size=12)
pdf.cell(33,10, txt=mydata['Experience'][0]['work'], ln= 1, align= 'R')
pdf.set_font('Times', '', size=12)
pdf.set_text_color(0,0,0)
pdf.cell(47,1, txt=mydata['Experience'][0]['company1'], ln= 1, align= 'R')
pdf.cell(95.2,8, txt=mydata['Experience'][0]['address'], ln=1, align= 'R')
pdf.cell(39,2, txt=mydata['Experience'][0]['Position'], ln= 1, align= 'R')

pdf.set_font('Courier', 'B', size=14)
pdf.set_text_color(102,71,34)
pdf.cell(0,12, txt='Reference', ln=1)
pdf.set_font('Times', 'B', size=12)
pdf.set_text_color(0,0,0)
pdf.cell(0,4, txt='Kusuo Saiki', ln=1)
pdf.set_font('Times', '', size=12)
pdf.set_text_color(0,0,0)
pdf.cell(0,4, txt='Senior Software Architect', ln=1)
pdf.cell(0,4, txt='+63 998 749 9043', ln=1)

# ---END OF CODE---
pdf.output("AZUELA,JULLIANE.pdf")
